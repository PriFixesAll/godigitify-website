...
export const metadata: Metadata = {
  title: 'Our Approach | GoDigitify',
  description:
    "Explore GoDigitify's growth systems methodology, leadership vision, and engineering principles for scalable enterprise digital infrastructure.",
};
